...
import com.khchan744.smart_qr_backend.dto.VerifyPaymentReqDto;
...
class SmartQrBackendApplicationTests {
	...
	void testVerifyPayment() {
		...
		VerifyPaymentReqDto verifyPaymentReqDto = new VerifyPaymentReqDto(paymentTokenBase64, payerUsername, paymentAmount, payeeMfBase64);
		...
		byte[] receivedPaymentAmountBytes = Utils.paymentAmountToBytes(verifyPaymentReqDto.getPaymentAmount());
